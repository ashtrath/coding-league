...
const Toast = ({ type = 'info', message, t }: ToastProps) => {
    return (
        <div
            className={`flex w-full max-w-sm items-center gap-2 rounded-md border border-gray-300 bg-white p-4 text-gray-900 shadow-lg ${t.visible ? 'animate-in fade-in-5 zoom-in-95 slide-in-from-top-2' : 'animate-out fade-out-0 slide-out-to-top-2 fill-mode-forwards'}`}
        >
            {type === 'success' && (
